...
<html>
    ...
    <body>
        ...
        <form name="formCadastrar" action="" method="">
            <div class="container-fluid">
                <div class="container" id="formulario">
                    ...
                    <div class="form-group">
                        <label>Email</label>
                        <input type="text" class="form-control" name="txtTelefone" placeholder="Telefone principal" required="required" />
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="txtDescricao" class="form-control" placeholder="Descrição resumida do processo" required="required"></textarea>
